...
@Controller
@RequestMapping(QuizTrasitionConst.ADMIN.PAGE_FACULTY_CREATE)
public class Faculty_create extends BaseControllerWeb {
    ...
    public String prepareEdit(Map<String, Object> inModel)throws QuizException {
        if(Objects.equals( getUser().getStrTopMenu(), "ADM") || Objects.equals( getUser().getStrTopMenu(), "")){
            ...
            return getDefaultPageMap(inModel, "A109_2");
        }else
