...
@Controller
@RequestMapping(QuizTrasitionConst.ADMIN.PAGE_EXAMINATION_DETAIL)
public class Examination_detail extends BaseControllerWeb {

    @RequestMapping("/{iExaminationInformationPk}")
    public String prepareEdit(Map<String, Object> inModel,
        ...
        if(Objects.equals( getUser().getStrTopMenu(), "ADM")
            ...
            return getDefaultPageMap(inModel, "A101_3");
        }else
