...
<h1 class="heading-1 margin-bottom background"><span>Thêm mới môn học </span></h1>

<div class="box-x-medium">
    <form id="form-create-subject" action="javascript:void(0);">
        <section class="form-border box-shadow-radius mt-default">
            ...
            <div class="form-content first-child row">
                ...
                <div class="col-xs-12 col-sm-7 col-md-65p">
                    <input class="form-control" type="text" nullable="false" id="strSubjectInformationName"/>
    ...
    <div class="modal-dialog box-medium">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title heading-1">Bạn có chắc chắn muốn môn học？</h4>
            </div>
...
<script src="${pageContext.request.contextPath}/js/admin/subject/subject_create.js"></script>
