...
<h1 class="heading-1 margin-bottom background"><span>Danh sách phòng thi</span></h1>
...
<div class="row row-small layout mt20">
    <div class="col-xs-12 col-sm-inline padding-small">
        <button class="btn btn-blue btn-reponsive btn-medium float-l" onclick="redirectPage('admin','a108_2');">Thêm mới</button>
    </div>
...
<script type="text/template7" id="template-delete-room-list">
    <div class="modal-dialog box-medium">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="btn-modal">
                    <button class="btn btn-delete btn-confirm btn-medium btn-fa" onclick="RoomList.deleteOne('{{iExaminationRoomPk}}')" >
                        Xóa
                    </button>
                </div>
                <div class="btn-modal">
...
<script type="text/template7" id="table-template-room-list">
    <tr>
        <td class="txt-center">{{index}}</td>
        <td id="iExaminationRoomPk">{{iExaminationRoomPk}}</td>
        <td>
...
<script src="${pageContext.request.contextPath}/js/admin/room/room_list.js"></script>
