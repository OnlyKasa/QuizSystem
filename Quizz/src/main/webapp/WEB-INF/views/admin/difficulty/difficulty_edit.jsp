...
<h1 class="heading-1 margin-bottom background"><span>Sửa đổi cài đặt độ khó </span></h1>

<div class="box-x-medium">
    <form id="form-update-difficulty" action="javascript:void(0);">
        <section class="form-border box-shadow-radius mt-default">
            <h3 class="heading-3">Thông tin cài đặt độ khó </h3>
            <div class="form-content first-child row">
                <div class="col-xs-9 col-sm-4 col-md-30p">
                    <div class="form-label">
                        <label>Tên cài đặt độ khó</label>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-7 col-md-65p">
                    <input class="form-control" type="text" readonly="readonly" id="strRateDifficultyName"/>
            ...
            <div class="layout main-btn txt-center mt30">
                ...
                <button class="btn btn-gray btn-radius mt-xs" onclick="redirectPage('admin','a102')" type="button">Trở về </button>
            </div>
        </section><!-- /.form-border -->
    </form>
</div><!-- /.box-x-medium -->
    ...
    <div class="modal-dialog box-medium">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title heading-1">Bạn có chắc chắn muốn sửa cài đặt độ khó？</h4>
            </div>
...
<script>
    var iRateOfDifficultyPk  = ${iRateOfDifficultyPk};
</script>
<script src="${pageContext.request.contextPath}/js/admin/difficulty/difficulty_edit.js"></script>
