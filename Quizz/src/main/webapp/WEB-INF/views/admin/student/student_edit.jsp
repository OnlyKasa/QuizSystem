...
<div class="box-x-medium">
    <form id="form-update-student" action="javascript:void(0);">
        <section class="form-border box-shadow-radius mt-default">
            ...
            <div class="form-content first-child row">
                ...
                <div class="col-xs-12 col-sm-7 col-md-65p">
                    <input class="form-control" type="text" readonly="readonly" id="iStudentInformationCode"/>
                    <p class="message-error" id="iStudentInformationCodeErr"> </p>
                </div>
            </div>
