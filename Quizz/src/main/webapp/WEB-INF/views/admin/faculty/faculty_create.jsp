...
<h1 class="heading-1 margin-bottom background"><span>Thêm mới khoa</span></h1>

<div class="box-x-medium">
    <form id="form-create-faculty" action="javascript:void(0);">
        <section class="form-border box-shadow-radius mt-default">
            ...
            <div class="layout main-btn txt-center mt30">
                ...
                <button class="btn btn-gray btn-radius mt-xs" onclick="redirectPage('admin','a109')" type="button">Trở về </button>
            </div>
        </section><!-- /.form-border -->
    </form>
</div><!-- /.box-x-medium -->
    ...
    <div class="modal-dialog box-medium">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title heading-1">Bạn có chắc chắn muốn tạo khoa？</h4>
            </div>
...
<script src="${pageContext.request.contextPath}/js/admin/faculty/faculty_create.js"></script>
