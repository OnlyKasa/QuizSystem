...
@Controller
@RequestMapping(QuizTrasitionConst.ADMIN.PAGE_TEACHER_CREATE)
public class Teacher_create extends BaseControllerWeb {
    ...
    public String prepareEdit(Map<String, Object> inModel)throws QuizException {
        if(Objects.equals( getUser().getStrTopMenu(), "ADM") || Objects.equals( getUser().getStrTopMenu(), "")){
            ...
            return getDefaultPageMap(inModel, "A107_2");
        }else
