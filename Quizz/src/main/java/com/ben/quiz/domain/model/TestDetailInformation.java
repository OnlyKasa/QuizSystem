...
public class TestDetailInformation extends BaseEntity implements Serializable {
    ...
    @Id
    @GenericGenerator(
            name = SequenceConst.TEST_DETAIL_INFORMATION_SEQ_GEN,
            strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator", parameters = {
            @org.hibernate.annotations.Parameter(name = "initial_value", value = "1"),
            @org.hibernate.annotations.Parameter(name = "sequence_name", value = SequenceConst.TEST_DETAIL_INFORMATION_SEQ)}
    )
