...
public interface ExaminationInformDetailRepository extends BaseRepository{
    ...
    List<ExaminationInformationDetail> findByExamination(Integer iExaminationInformationPk, PagingReq pagingReq) throws QuizException;

    long countByExamination(Integer iExaminationInformationPk )throws QuizException;
