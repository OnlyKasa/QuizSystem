...
////    @Override
////    @Transactional
////    public void resetPassword(ForgotPasswordReq forgotPasswordReq) throws GoovalException {
...
////    @Override
////    @Transactional
////    public void changePassword(ChangePasswordReq changePasswordReq) throws GoovalException {
...
////        try {
////            if (userID.isEmpty()) {
////                return Constant.responseError(CodeConst.ErrorCode.ERR_010, null);
////            }
...
//        try {
//            sUser = new SUser();
//            return JspUtil.redirect(GoovalTrasitionConst.AUTH.C101, request);
//        } catch (Exception ex) {
//            Logger.getLogger(UserServiceImpl.class).error(ex);
//            return null;
//        }
...
//
//    @Override
//    public Seiuser findUserByUserNameAndPassword(String userName, String password) throws GoovalException {
//        return userRepository.findSeiuserByUseridAndPassword(userName, password);
//    }
//
//    @Override
//    public Seiuser findUserByUserName(String userName) throws GoovalException {
//        return userRepository.findSeiuserByUserid(userName);
//    }
//
//    public void getUserInfo(SUser user) throws GoovalException {
